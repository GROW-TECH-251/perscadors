          ...
          <>
            ...
            <div className="mt-12 text-center">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-brand-bg-alt border border-brand-gold/20 hover:border-brand-gold/40 hover:bg-brand-gold/5 rounded-full text-sm font-medium text-brand-text hover:text-brand-gold transition-all duration-300"
              >
