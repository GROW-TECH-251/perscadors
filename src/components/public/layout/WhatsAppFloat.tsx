...
export const WhatsAppFloat: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <span className="max-w-0 overflow-hidden whitespace-nowrap font-bebas text-lg uppercase tracking-wider group-hover:max-w-xs transition-all duration-(--motion-smooth) ease-out-luxe pr-0 group-hover:pr-2">
        Deal avec Vioutou
      </span>
